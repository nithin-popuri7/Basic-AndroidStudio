...
## RESULT:
Thus the developing a application to add animations to ImageView,Move,blink,fade,clockwise,zoom,slide operations are perform in android studio implemented Successfully.
